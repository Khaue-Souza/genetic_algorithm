...
def main():
    ...
    saco_dormir = Mochila('Saco de dormir', 15, 15)
    tocha = Mochila('Tocha', 5, 5)

    itens = [canivete, comida, corda, garrafa, saco_dormir, tocha, ]
    ...
    printar_itens_selecionados(best_match_idx, itens, new_population)


def printar_itens_selecionados(best_match_idx, itens, new_population):
